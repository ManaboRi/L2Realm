...
function manualContent(q, parsed, availabilityInfo) {
  ...
  if (q.source === 'https://linedia.ru/wiki/Path_of_the_Artisan') {
    return [
      '## Что это',
      '',
      '**Путь Ремесленника** — квест на первую профессию гнома-ремесленника. Маршрут начинается в деревне гномов, а дальше можно пройти ветку через Глудин и Глудио.',
      '',
      '## Требования',
      '',
      ...
      '## Прохождение',
      '',
      '1. Поговорите с **Сильверой** в кузнице деревни гномов и получите первое поручение.',
      '2. Спуститесь в **Заброшенный Угольный Рудник**. Убейте **Boogle Ratman Leader**, чтобы собрать **2 Boogle Ratman Leader\'s Tooth**, и **Boogle Ratman**, чтобы собрать **10 Boogle Ratman Tooth**.',
      '3. Вернитесь к **Сильвере** и получите **1st Pass Certificate**. Для ветки через Глудин выберите вариант испытания в районе Глудио.',
      '4. В кузнице **Глудина** поговорите с **Клуто** и заберите письмо для Пинтера.',
      '5. В кузнице **Глудио** поговорите с **Пинтером**. Он отправит вас найти след вора.',
      '6. Вернитесь в район **Глудина** и охотьтесь на **Vuku Orc Fighter**, пока не получите **Stolen Secret Box**.',
      '7. Сдайте ящик **Пинтеру** в Глудио и получите **2nd Pass Certificate**.',
      '8. Вернитесь к **Клуто** в Глудин. В диалоге выберите вариант, что ящик у вас есть, но вы не знаете, для чего он нужен.',
      '9. Получите **Final Pass Certificate**. На 20 уровне поговорите с **Тапоем** в кузнице Глудина и смените профессию на ремесленника.',
      '',
      '## Награда',
      '',
  ...
  if (q.source === 'https://linedia.ru/wiki/Lizardmen%27s_Conspiracy') {
    return [
      '## Что это',
      '',
      '**Заговор Ящеров** — короткий квест у западных ворот Глудио. Нужно проверить доклад стражи и собрать кристаллы с ящеров Мэль и арахнидов.',
      '',
      '## Требования',
      '',
      `- Хроники: **${availabilityInfo.label}**`,
      `- Уровень: **${lvl}**`,
      '- Стартовый NPC: **Праг** у западных ворот Глудио',
      '',
      '## Прохождение',
      '',
      '1. Поговорите со стражем **Прагом** у западных ворот **Глудио** и получите доклад патруля.',
      '2. Отнесите доклад **Магистру Ромеру** в храме или магической гильдии Глудио.',
      '3. Отправляйтесь в **Лагерь Ящеров Мэль**.',
      '4. Убивайте **Maille Lizardman Warrior**, **Maille Lizardman Shaman** и **Maille Lizardman Matriarch**, пока не соберёте **50 Shining Gem**.',
      '5. Там же охотьтесь на **Poison Araneid** и **King of the Araneid**, пока не соберёте **50 Shining Red Gem**.',
      '6. Вернитесь к **Ромеру** в Глудио и сдайте оба набора кристаллов.',
      '',
      '## Награда',
      '',
      reward || '42,000 :sp:',
  ...
  if (q.source === 'https://linedia.ru/wiki/Grim_Collector') {
    return [
      '## Что это',
      '',
      '**Беспощадный коллекционер** — повторяемый заработок на костях и частях нежити. Вы берёте поручение в Глудио, охотитесь в руинах и сдаёте трофеи за адену.',
      '',
      '## Требования',
      '',
      `- Хроники: **${availabilityInfo.label}**`,
      `- Уровень: **${lvl}**`,
      '- Стартовый NPC: **Кертис** у южных ворот Глудио',
      '',
      '## Прохождение',
      '',
      '1. Поговорите со стражем **Кертисом** у южных ворот **Глудио**.',
      '2. Найдите **Самеда** внутри города, недалеко от круглого здания западнее южных ворот, и получите схему для сбора останков.',
      '3. Отправляйтесь в **Руины Отчаяния** или **Руины Страданий**.',
      '4. Охотьтесь на скелетов и зомби: **Skeleton Infantryman**, **Shield Skeleton**, **Zombie Soldier**, **Ruin Zombie**, **Tracker Skeleton**, **Skeleton Scout**, **Skeleton Bowman** и похожую нежить в руинах.',
      '5. Собирайте части тел: **Deadman\'s Skull**, **Deadman\'s Rib Bone**, **Deadman\'s Arm Bone**, **Deadman\'s Spine**, **Deadman\'s Thigh Bone**, **Zombie Head**, **Zombie Heart** и **Zombie Liver**.',
      '6. Вернитесь к **Самеду** и сдайте найденные останки. Чем больше предметов принесёте, тем больше получите адены.',
      '7. Квест можно повторять, пока удобно фармить нежить в руинах.',
      '',
      '## Награда',
      '',
      reward || ':adena:',
  ...
  if (q.source === 'https://linedia.ru/wiki/Test_of_the_Searcher') {
    return [
      '## Что это',
      '',
      '**Испытание ищущего** — третий профессиональный квест для будущих искателей. Это длинная цепочка расследования: Лютер отправляет вас к Алексу, затем маршрут проходит через Флоран, Глудио, Гнездо Пауков, Пустошь и несколько охотничьих зон.',
      '',
      '## Требования',
      '',
      `- Хроники: **${availabilityInfo.label}**`,
      `- Уровень: **${lvl}**`,
      '- Стартовый NPC: **Лютер** в Деревне Охотников',
      '- Важно: заранее освободите место в инвентаре под карты и отчёты.',
      '',
      '## Прохождение',
      '',
      '1. В **Деревне Охотников** поговорите с **Лютером** и получите письмо.',
      '2. Отправляйтесь к **Алексу** возле **Флорана**, затем поговорите с **Лейрин** у развилки к юго-западу от деревни.',
      '3. В районе **Гавани Гирана** убивайте **Delu Lizardman Shaman**, пока не соберёте **10 Delu Totem**.',
      '4. Вернитесь к **Лейрин**. Затем найдите и убейте квестового **Delu Chief Kalkis**, чтобы получить клык и странную карту.',
      '5. Сдайте находки **Лейрин** и **Алексу**. После этого цепочка отправит вас в **Глудио** к **Пьяному Борису**.',
      '6. Борис направит к **Тире** в **Гнездо Пауков**. Возьмите у неё контракт.',
      '7. В **Море Спор** убивайте **Giant Fungus**, пока не соберёте **10 Red Spore Dust**. Вернитесь к **Тире** и получите вино.',
      '8. Сдайте вино **Борису** в Глудио и получите старый приказ.',
      '9. В **Пустоши** найдите **Джакса**, затем соберите части карты: в **Землях Казнённых** с **Hangman Tree** и в **Долине Смерти** с **Road Scavenger**.',
      '10. Вернитесь по цепочке к **Джаксу**, **Алексу** и **Лютеру**, чтобы завершить испытание и получить знак.',
      '',
      '## Награда',
      '',
  ...
  if (q.source === 'https://linedia.ru/wiki/Test_of_the_War_Spirit') {
    return [
      '## Что это',
      '',
      '**Испытание вестника** — третий профессиональный квест орков. Главная часть маршрута — собрать останки героев орков через несколько шаманов и охотничьих зон.',
      '',
      '## Требования',
      '',
      `- Хроники: **${availabilityInfo.label}**`,
      `- Уровень: **${lvl}**`,
      '- Стартовый NPC: **Сомак** в Дионе',
      '- Подготовьте телепорты в Дион, Глудио, Орен и Гиран.',
      '',
      '## Прохождение',
      '',
      '1. В **Дионе** поговорите с **Сомаком** и получите первое поручение.',
      '2. В **Долине Смерти** найдите **Орима**. Он отправит вас в **Башню Крумы**.',
      '3. На первом этаже **Башни Крумы** убивайте **Excuro**, **Porta** и **Mordeo**, пока не соберёте чешую, глаза и когти для Орима.',
      '4. Вернитесь к **Орима** и получите останки Браки.',
      '5. В **Глудио** поговорите с **Ракоем**, затем с **Вивиан** в храме и с **Сариеном** у входа в Пустошь.',
      '6. В **Муравейнике** охотьтесь на **Noble Ant** и **Noble Ant Leader**, пока не соберёте части останков Кируны. Сдайте их **Ракою**.',
      '7. В **Орене** поговорите с **Пекиронoм**. Убивайте **Leto Lizardman Shaman**, пока не соберёте останки Тонара, и вернитесь к Пекирону.',
      '8. В **Гиране** поговорите с **Манакией**. Охотьтесь на **Medusa** и квестовую **Stenoa Gorgon Queen**, пока не соберёте останки Гермодта.',
      '9. Вернитесь к **Манакии**, затем к **Сомаку**. После сдачи всех останков получите знак испытания.',
      '',
      '## Награда',
      '',
