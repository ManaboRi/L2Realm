...
- [x] Вкладка «Монетизация»: 5 VIP-слотов с датами окончания и кнопкой «Снять», таблица активных/истёкших бустов, ручная выдача VIP/буста любому серверу, инфо-карточка «Сервер дня сегодня»
...
| ◆ VIP Скоро | Отдельный VIP-блок в «Скоро открытие» | 31 день | 2 000 ₽ | Всего 5 мест |
| ★ Сервер дня | Случайный из пула без VIP/буста, изумрудная подсветка | 5 ч | Бесплатно | Автоматически раз в 5 часов |
