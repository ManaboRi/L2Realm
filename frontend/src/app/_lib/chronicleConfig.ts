...
export const CHRONICLE_CONFIGS: Record<string, ChronicleCfg> = {
  interlude: {
    ...
    description: 'Каталог приватных серверов Lineage 2 Interlude. Хроника C6 — самая популярная и сбалансированная. Рейты, проверка проектов, активность и голоса игроков.',
  ...
  'high-five': {
    ...
    description: 'Каталог приватных серверов Lineage 2 High Five. Расширенная классика с обновлениями интерфейса, новыми зонами и квестами. Рейты, проверка проектов, активность и голоса игроков.',
  ...
  classic: {
    ...
    description: 'Каталог приватных серверов Lineage 2 Classic. Современная NCSoft-версия классики 2018 года. Рейты, проверка проектов, активность и голоса игроков.',
  ...
  kamael: {
    ...
    description: 'Каталог приватных серверов Lineage 2 Kamael. Хроники с расой Камаэль, арбалетчиками, берсерками и классическим PvP. Рейты, проверка проектов, активность и голоса игроков.',
  ...
  gracia: {
    ...
    description: 'Каталог приватных серверов Lineage 2 Gracia. Хроники Final/Epilogue, новые SA, фрагменты Камаэль и атрибуты оружия. Рейты, проверка проектов, активность и голоса игроков.',
  ...
  main: {
    ...
    description: 'Каталог приватных серверов Lineage 2 Main. Современные хроники, актуальный клиент, новые классы и механики. Рейты, проверка проектов, активность и голоса игроков.',
