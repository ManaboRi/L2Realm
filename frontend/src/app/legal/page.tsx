      ...
      <div className={styles.wrap}>
        ...
        <section className={styles.card}>
          ...
          <ul className={styles.list}>
            ...
            <li><strong>Буст 🔥</strong> — 250 ₽ за 7 дней. Сервер поднимается выше обычных позиций с меткой «огонёк».</li>
          </ul>
          ...
          <p>
            ...
            изменения на сайте (VIP-блок / метка буста у своего сервера) без дополнительных действий. Срок оказания —
            31 календарный день для VIP и 7 календарных дней для буста, отсчёт с момента активации.
          </p>
