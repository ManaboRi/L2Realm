  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.wrap}>
        ...
        <section className={styles.card}>
          <h2 className={styles.cardTitle}>Правообладатели и статус проекта</h2>
          <p>
            L2Realm не является официальным ресурсом, не аффилирован с NCSoft Corp., NC Interactive LLC,
            ООО «Иннова», 4game или другими правообладателями игры Lineage 2. Торговая марка Lineage
            и связанные обозначения являются собственностью соответствующих правообладателей.
          </p>
          <p>
            Сайт является информационным каталогом и публикует сведения о сторонних игровых проектах
            на основании открытых источников и/или данных, предоставленных администраторами проектов.
            L2Realm не размещает клиентские файлы игры, патчи или иные материалы правообладателей.
          </p>
        </section>
        ...
        <section className={styles.card}>
          ...
          <p>
            Исполнитель не несёт ответственности за любые прямые или косвенные убытки Заказчика, возникшие
            в связи с использованием Сайта, временной недоступностью сервиса, техническими сбоями, действиями
            третьих лиц, изменением интерфейса, правил модерации, поисковой индексации или алгоритмов ранжирования,
            если иное прямо не предусмотрено обязательными нормами закона.
          </p>
          <p>
            Исполнитель не гарантирует конкретное количество переходов, регистраций, голосов, игроков, продаж
            или иную коммерческую эффективность размещения, если такая гарантия прямо не указана в описании
            оплаченной услуги.
          </p>

          <h3 className={styles.h3}>7. Техническая недоступность и форс-мажор</h3>
          <p>
            Если оплаченная услуга не отображалась на Сайте из-за технической недоступности L2Realm более 24 часов
            подряд, срок оказания соответствующей услуги продлевается на период подтверждённого простоя либо,
            по соглашению сторон, производится пропорциональный возврат.
          </p>
          <p>
            Стороны освобождаются от ответственности за неисполнение обязательств, если оно вызвано обстоятельствами
            непреодолимой силы: авариями у хостинг-провайдеров, массовыми сетевыми сбоями, действиями государственных
            органов, блокировками, военными действиями, чрезвычайными ситуациями и иными событиями, которые стороны
            не могли разумно предотвратить.
          </p>

          <h3 className={styles.h3}>8. Изменение условий</h3>
          <p>
            Исполнитель вправе изменять состав услуг, цены и условия настоящей оферты. Новая редакция публикуется
            на этой странице. Существенные изменения условий по возможности публикуются не менее чем за 10 календарных
            дней до вступления в силу, кроме срочных изменений, связанных с требованиями закона, безопасностью Сайта,
            платёжными системами или прекращением спорного/незаконного размещения.
          </p>
          <p>
            Изменения не ухудшают условия уже оплаченных услуг до окончания оплаченного периода и сами по себе
            не являются основанием для возврата средств за уже оказанные или активированные услуги, если иное
            не требуется обязательными нормами закона.
          </p>

          <h3 className={styles.h3}>9. Акцепт оферты</h3>
          <p>
          ...
          <h3 className={styles.h3}>10. Персональные данные</h3>
          <p>
