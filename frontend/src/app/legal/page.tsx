      ...
      <div className={styles.wrap}>
        ...
        <section className={styles.card}>
          ...
          <ul className={styles.list}>
            <li><strong>VIP-размещение</strong> — 5 000 ₽ за 31 день. Сервер отображается в отдельном блоке «VIP» в верхней части каталога с подсветкой и бейджем. Количество мест — 8.</li>
            ...
            <li><strong>VIP в «Скоро открытие»</strong> — 2 000 ₽ за 31 день. Сервер отображается в отдельном VIP-блоке раздела «Скоро открытие» с подсветкой и бейджем. Количество мест — 8.</li>
          </ul>
