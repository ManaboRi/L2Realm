      ...
      <div className={styles.wrap}>
        ...
        <section className={styles.card}>
          ...
          <ul className={styles.list}>
            <li><strong>VIP-размещение</strong> — 5 000 ₽ за 31 день. Сервер отображается в отдельном блоке «VIP» в верхней части каталога с подсветкой и бейджем.</li>
            <li><strong>Буст 🔥</strong> — 500 ₽ за 7 дней. Сервер поднимается выше обычных позиций с меткой «огонёк».</li>
            <li><strong>«Скоро открытие» ⏳</strong> — 1 000 ₽ разово. Платное размещение анонса сервера, ещё не открытого на момент оплаты, в специальном разделе «Скоро открытие». Услуга оказывается с момента оплаты до даты открытия, указанной Заказчиком в форме.</li>
          </ul>
          ...
          <p>
            Услуга активируется автоматически в течение нескольких секунд после подтверждения оплаты. Заказчик видит
            изменения на сайте (VIP-блок / метка буста / появление сервера в разделе «Скоро открытие») без дополнительных
            действий. Сроки оказания: 31 календарный день для VIP, 7 календарных дней для буста; для размещения «Скоро
            открытие» — с момента оплаты до даты открытия, указанной Заказчиком (после открытия сервер автоматически
            переходит в обычный каталог).
          </p>
